...
void checkCalc(){
    Serial.print(pwmE);Serial.print("; u=");
    Serial.print(u1);Serial.print("; e=");
    Serial.print(e1);Serial.print("; dedt=");
    Serial.print(dedt1);Serial.print("; i=");
    Serial.print(eintegral1);Serial.print("; intrp=");
